...
if (isset($headers['Authorization'])) {
    ...
    if (preg_match('/Bearer (.+)/', $authorizationHeader, $matches)) {
        ...
        $query = "SELECT products.*,attachments.url FROM products LEFT JOIN product_attachments on product_attachments.product_id=products.id LEFT JOIN attachments on attachments.id = product_attachments.attachment_id";
